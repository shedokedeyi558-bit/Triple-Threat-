            ...
            >
              {tab === "deposit" ? (
                ...
                <>
                  ...
                  {/* ── Withdrawal processing info + WhatsApp support ── */}
                  <div className="rounded-xl p-4 space-y-2.5" style={{ backgroundColor: "var(--bg-base)", border: "1px solid var(--border-hairline)" }}>
                    <p className="text-xs font-semibold" style={{ color: "var(--text-secondary)" }}>
                      ℹ️ How withdrawals work
                    </p>
                    <p className="text-[11px] leading-relaxed" style={{ color: "var(--text-muted)" }}>
                      After you submit, your request is reviewed and paid out manually within 24 hours.
                      You may be contacted on your registered phone number to complete the transfer.
                      Keep your phone accessible.
                    </p>
                    <a
                      href="https://wa.me/2349116041880?text=Hi%2C%20I%20need%20help%20with%20my%20BitLyfe%20withdrawal"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-center gap-2 w-full py-2.5 rounded-lg text-xs font-bold transition-all active:scale-95"
